    ...
    <section className="relative z-10 px-6 py-24 bg-slate-900/50">
      <div className="max-w-6xl mx-auto">
              ...
              >
                {tier.popular && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                    <span className={`${c.badge} text-white text-xs font-medium px-4 py-1 rounded-full whitespace-nowrap`}>
                      Recomandat
                    </span>
                  </div>
                )}
                ...
                <div className="mb-5">
                  <div className="flex items-baseline gap-1.5">
                    <span className="text-4xl font-heading font-medium text-white">{price}</span>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-slate-900/80 border border-slate-700 rounded-xl p-7 shadow-token-md">
