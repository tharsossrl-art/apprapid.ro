    ...
    <div className="min-h-screen bg-slate-950 text-white overflow-x-hidden">
        ...
        <div className="max-w-6xl mx-auto w-full">
          ...
          <div className="flex-1">
            <motion.h1
              ...
              className="text-5xl md:text-7xl font-heading font-medium tracking-wide leading-[1.1] mb-6"
            >
              Afacerea ta,{' '}
      ...
      <section className="relative z-10 px-6 py-20 bg-slate-900/30">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-heading font-medium tracking-wide mb-4">
              De ce{' '}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-fuchsia-400">
                aplicație mobilă?
              </span>
