      ...
      <div className="px-6 py-16 md:py-20 text-center">
        <div className="max-w-5xl mx-auto">
          ...
          <motion.h1
            ...
            className="text-5xl md:text-7xl lg:text-8xl font-heading font-medium tracking-wide leading-[1.05] mb-6"
          >
            Tot ce are nevoie{' '}
          ...
          <motion.p
            ...
            className="text-lg md:text-xl font-light text-slate-400 max-w-2xl mx-auto mb-12"
          >
          ...
          >
            <a
              href="#servicii"
              className="group relative px-7 py-3 bg-gradient-to-r from-blue-500 to-emerald-500 hover:from-blue-600 hover:to-emerald-600 rounded-lg font-medium text-sm tracking-wider text-white transition-all duration-300 ease-premium overflow-hidden shadow-[0_2px_8px_rgba(96,165,250,0.2)]"
            >
            ...
            <a
              ...
              className="px-7 py-3 bg-slate-800/50 border border-slate-700 hover:border-slate-600 rounded-lg font-medium text-sm tracking-wider text-white transition-all duration-300 ease-premium flex items-center gap-2"
            >
