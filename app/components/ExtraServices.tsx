      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="relative bg-gradient-to-br from-blue-900/20 to-blue-900/5 border border-blue-500/20 rounded-xl p-7 hover:border-blue-500/40 transition-premium shadow-token-md hover:shadow-token-lg group">
            ...
            <div className="w-12 h-12 rounded-lg bg-blue-500/20 flex items-center justify-center mb-4 mt-2">
            ...
            <div className="flex items-baseline gap-2 mb-1">
              <span className="text-4xl font-heading font-semibold text-white">999</span>
          ...
          <div className="bg-slate-900/80 border border-slate-700 rounded-xl p-7 hover:border-slate-600 transition-premium shadow-token-md hover:shadow-token-lg group">
            ...
            <div className="flex items-baseline gap-2 mb-1">
              <span className="text-4xl font-heading font-semibold text-white">399</span>
              <span className="text-slate-400 text-lg">RON</span>
            </div>
            <p className="text-slate-500 text-xs mb-4">plată unică, fără abonament</p>
          ...
          <div className="bg-slate-900/80 border border-slate-700 rounded-xl p-7 hover:border-slate-600 transition-premium shadow-token-md hover:shadow-token-lg group">
            ...
            <div className="flex items-baseline gap-2 mb-1">
              <span className="text-4xl font-heading font-semibold text-white">499</span>
              <span className="text-slate-400 text-lg">RON</span>
            </div>
            <p className="text-slate-500 text-xs mb-4">plată unică, fără abonament</p>
        ...
        {/* Bundle upsell */}
        <div className="mt-8 bg-gradient-to-r from-blue-500/10 via-emerald-500/10 to-amber-500/10 border border-white/10 rounded-xl p-6 md:p-8 text-center">
