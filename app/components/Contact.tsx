      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-10">
          ...
          <div className="bg-slate-900/80 border border-slate-700 rounded-xl shadow-token-md p-8">
            <h3 className="text-xl font-heading font-medium tracking-wide mb-6 flex items-center gap-3">
          ...
          <div className="space-y-6">
            {/* Quick contact */}
            <div className="bg-slate-900/80 border border-slate-700 rounded-xl shadow-token-md p-8">
              <h3 className="text-xl font-heading font-medium tracking-wide mb-6">Sau contactează-ne direct</h3>
              ...
              <div className="space-y-4">
                <a
                  ...
                  className="flex items-center gap-4 p-4 bg-emerald-500/10 border border-emerald-500/30 rounded-xl hover:bg-emerald-500/20 transition-all duration-300 ease-premium group"
                >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="font-light text-slate-400 text-sm">+40 756 870 425</div>
                  </div>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-4 p-4 bg-blue-500/10 border border-blue-500/30 rounded-xl hover:bg-blue-500/20 transition-all duration-300 ease-premium group"
                >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="font-light text-slate-400 text-sm">tharsossrl@gmail.com</div>
                  </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-slate-900/80 border border-slate-700 rounded-xl shadow-token-md p-5 text-center hover:border-slate-600 transition-all duration-300 ease-premium">
                ...
                <div className="text-xs font-light text-slate-500">România</div>
              </div>
              ...
              <div className="bg-slate-900/80 border border-slate-700 rounded-xl shadow-token-md p-5 text-center hover:border-slate-600 transition-all duration-300 ease-premium">
                ...
                <div className="text-xs font-light text-slate-500">în max. 24h</div>
              </div>
            </div>

            {/* Trust badge */}
            <div className="bg-gradient-to-br from-blue-500/10 to-emerald-500/10 border border-slate-700 rounded-xl shadow-token-md p-5 hover:border-slate-600 transition-all duration-300 ease-premium">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs font-light text-slate-400">Datele tale sunt în siguranță și nu le împărtășim cu nimeni.</div>
                </div>
              </div>
            </div>
          </div>
